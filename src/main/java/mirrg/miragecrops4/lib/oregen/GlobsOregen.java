...
public class GlobsOregen
{
	...
	public static enum EnumGlobGroup
	{
		...
		static
		{
			...
			{
				GlobGroup<Glob> g = CalciteGroup.globGroup;
			...
			{
				GlobGroup<Glob> g = MohsHardnessCrystal.globGroup;
				setAllowsSlot(g, true, true, false, true, true);
			...
			{
				GlobGroup<Glob> g = OtherMetal.globGroup;
			...
			{
				GlobGroup<Glob> g = MirageMagic.globGroup;
			...
			{
				GlobGroup<Glob> g = MirageMaterial.globGroup;
