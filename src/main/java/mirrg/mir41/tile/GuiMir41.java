...
import mirrg.mir41.tile.renderer.IGuiRenderHelper;
import mirrg.mir41.tile.renderer.IRenderer;
import mirrg.mir41.tile.renderer.IRendererProvider;
import mirrg.mir41.tile.renderer.RendererEnergySlotProgress;
import mirrg.mir41.tile.renderer.RendererFluidSlot;
import mirrg.mir41.tile.renderer.RendererSlot;
...
public class GuiMir41 extends GuiContainer
{

	protected final ResourceLocation guiTexture;
	protected final ContainerMir41 container;
	protected final GuiRenderHelperImpl handler = new GuiRenderHelperImpl();

	public GuiMir41(ContainerMir41 container, ResourceLocation guiTexture)
	{
		super(container);
	...
	public class GuiRenderHelperImpl implements IGuiRenderHelper
	{
		...
		{
			GuiMir41.this.drawGradientRect(x1, y1, x2, y2, color1, color2);
		}
		...
		{
			GuiMir41.this.drawHoveringText(list, mouseX, mouseY, font);
		}
