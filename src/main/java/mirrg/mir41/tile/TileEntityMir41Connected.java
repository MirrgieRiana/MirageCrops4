...
import mirrg.mir41.tile.inventory.EnergyTank;
...
public class TileEntityMir41Connected extends TileEntityMir41 implements IPipeConnection, IFluidHandler, ISidedInventory
{
	...
	public void readFromNBT(NBTTagCompound p_145839_1_)
	{
		...
		for (Tuple<Inventory, String> entry : inventories) {
			...
			if (p_145839_1_.hasKey(entry.getY(), EnumNBTTypes.COMPOUND.ordinal())) {
